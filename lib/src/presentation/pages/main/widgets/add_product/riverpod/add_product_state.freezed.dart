...
mixin _$AddProductState {
  ...
  List<ToppingData> get typedExtras => throw _privateConstructorUsedError;
...
class _$AddProductStateImpl extends _AddProductState {
  const _$AddProductStateImpl(
      ...
      final List<ToppingData> typedExtras = const [],
  ...
  final List<ToppingData> _typedExtras;
  @override
  @JsonKey()
  List<ToppingData> get typedExtras {
...
abstract class _AddProductState extends AddProductState {
  const factory _AddProductState(
      {final bool isLoading,
      final bool isReviewing,
      final List<ToppingData> typedExtras,
