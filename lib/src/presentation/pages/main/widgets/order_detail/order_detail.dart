...
import 'package:garista_pos/src/presentation/pages/main/widgets/order_detail/order_riverpod/order_details_provider.dart';
import 'package:garista_pos/src/presentation/pages/main/widgets/order_detail/order_riverpod/order_details_state.dart';
...
class _OrderDetailPageState extends ConsumerState<OrderDetailPage> {
  ...
  Widget build(BuildContext context) {
    final state = ref.watch(orderDetailsProvider);
      ...
      print('Dish name: ${state.order?.dishes?.length}');

    num subTotal = 0;
    subTotal = safeConvertToNum(state.order?.total); 
    return SafeArea(
      child: Scaffold(
  ...
  AlertDialog _changeStatusDialog(OrderDetailsState state,BuildContext context) {
    return AlertDialog(
      content: PopupMenuButton<String>(
        itemBuilder: (context) {
          return [
